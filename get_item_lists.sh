...
#  | sort | uniq > data/boia_ht_item_ids.$D.txt 
...
# 
# # FRUS: 155520420
# bundle exec ruby get_ht_ids_by_series.rb 'Foreign Relations' | sort | uniq\
...
#   | sort | uniq > data/epa_ht_item_ids.$D.txt
...
# CRC: 1491645774
bundle exec ruby get_ht_ids_by_series.rb 'Civil Rights Commission' | sort | uniq\
...
# All: 2062901859
bundle exec ruby get_ht_ids.rb | sort | uniq > data/all_ht_item_ids.$D.txt
...
bundle exec ruby get_ht_ids_by_series.rb 'Congressional Serial Set' | sort | uniq\
